...
public class admin_SignUp extends JFrame implements ActionListener{
	...
	public admin_SignUp() {
		...
		lblNewLabel.setBounds(133, 28, 246, 31);
	...
	public void actionPerformed(ActionEvent e) {
		...
		int cN = Integer.parseInt(ContactNo);
		...
		try {
			 ...
			 String query = "insert into admin(ADMIN_ID,ADMIN_FIRSTNAME,ADMIN_LASTNAME,EMAIL,CONTACT,ADDRESS,PASSWORD)  values(?,?,?,?,?,?,?)";
